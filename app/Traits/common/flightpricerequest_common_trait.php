...
trait FlightPriceRequestCommonTrait{
    ...
    public function rules()
    {
        return [
            ...
            'oneway_date' => ['required_without_all:roundtrip_start_date,roundtrip-end-date', new DateDiff1d('oneway_date')],
            'roundtrip_start_date' => ['required_with:roundtrip-end-date', new DateDiff1d('roundtrip_start_date')],
            'roundtrip-end-date' => ['required_with:roundtrip_start_date', new DateDiff1d('roundtrip-end-date')],
