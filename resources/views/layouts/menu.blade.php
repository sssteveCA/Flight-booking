    ...
    <div class="container-fluid px-3">
        ...
        <div class="collapse navbar-collapse px-md-5" id="main_menu">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ $urlAboutUs }}">Chi siamo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('news.index') }}">News</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ $urlContacts }}">Contatti</a>
                </li>
                @if (Route::has('login'))
                    @auth
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right w-100" aria-labelledby="navbarDropdown">
                            <a href="{{ route($routeInfo) }}" class="dropdown-item">Il mio profilo</a>
                            <a href="{{ route('myFlights.index') }}" class="dropdown-item">I miei voli</a>
                            <a href="{{ route('myHotels.index') }}" class="dropdown-item">Le mie stanze</a>
